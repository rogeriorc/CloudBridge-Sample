...
//    cdnify: 'grunt-google-cdn'
  ...
  var appConfig = {
	...
	appName: packageJson.name || bowerJson.name || 'appName',
	appVersion: packageJson.version || bowerJson.version || 'appVersion',
    dist: 'build/dist',
	temp: 'build/temp',
	build: 'build'
  };
...
//    },
	...
	*/
	...
	compress: {
		main: {
			options: {
				archive: '<%= yeoman.build %>/<%= yeoman.appName %>-<%= yeoman.appVersion %>.zip'
			},
			files: [
				{
					expand: true,
